    ...
    <section>
        <div>
            ...
            <div className='grid grid-cols-3 p-5'>
                ...
                <div>
                    <CircleCheck/><h1 className='font-semibold text-sm'>Processo de seleção</h1>
                    <p className='text-[12px] text-gray-500'>Primeiro, escolheremos aleatoriamente um conjunto de hóspedes em potencial. Em seguida, analisaremos suas respostas para entender suas perspectivas e conexão com o ícone. Por fim, convidaremos os hóspedes selecionados a reservarem.</p></div>
                <div>
                    <IdCard /><h1 className='font-semibold text-sm'>Requisitos</h1>
                    <p className='text-[12px] text-gray-500'>Para participar, você precisa ter uma conta ativa no Airbnb, o aplicativo do Airbnb e ser residente em um país ou região elegível. A participação é gratuita.</p></div>
            </div>
