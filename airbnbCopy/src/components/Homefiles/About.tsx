...
export default function About() {
  return (
    <>
        ...
        <div className='mobile:hidden z-10 bg-white w-full flex justify-center gap-6 shadow-2xl fixed bottom-0 pt-4 ' >
            <p className='font-semibold text-[24px]'>Encerrado</p>
            <div className='h-12 w-52 rounded-xl bg-gray-400 flex justify-center items-center'>
                <p className=' text-white text-[16px] font-semibold'>Enviar Pedido</p>
            </div>
        </div>
