  ...
  return (
        ...
        <div class="container">
            ...
            <div class="container-fotos">
                <div class="box-title">
                <div class="separar-transl-title">
                    <svg xmlns="http://www.w3.org/2000/svg" alt="Imagem traducao" viewBox="0 0 16 16"
                    aria-label="Título traduzido automaticamente: Divirta-se no mundo da Polly Pocket" role="img"
                    focusable="false" style="display: block; height: 24px; width: 24px; fill: currentcolor;">
                    <path
                        d="M9 0a1 1 0 0 1 1 .88V6h5a1 1 0 0 1 1 .88V15a1 1 0 0 1-.88 1H7a1 1 0 0 1-1-.88V10H1a1 1 0 0 1-1-.88V1a1 1 0 0 1 .88-1H9zm1.73 7-1.4.5.24.21.13.13c.12.13.23.25.3.36l.08.1.05.07.04.08H7.31v1.3h1.2l.17.53.1.26.1.3A6.3 6.3 0 0 0 10 12.61c-.5.32-1.12.61-1.87.87l-.33.11-.35.11-.44.14.72 1.15.4-.13.4-.12c1-.35 1.83-.76 2.48-1.22.57.4 1.28.77 2.12 1.08l.37.14.38.12.41.13.72-1.15-.45-.14-.26-.08-.34-.11a9.23 9.23 0 0 1-1.94-.9 6.3 6.3 0 0 0 1.07-1.7l.13-.31.11-.33.17-.52h1.2V8.45h-3.05l-.1-.23A3.7 3.7 0 0 0 11 7.3l-.12-.15-.14-.15zm1.35 2.76-.04.13-.08.22-.1.27a4.99 4.99 0 0 1-.86 1.38 4.95 4.95 0 0 1-.74-1.13l-.12-.25-.1-.27-.08-.22-.04-.13h2.16zM9 1H1v8h5V7l.01-.17H3.83L3.43 8H2l2.26-6h1.48l1.5 4H9V1zM5 3.41 4.25 5.6h1.5L5 3.41z">
                    </path>
                    </svg>
                    <h1>Abertura dos Jogos Olímpicos no Museu de Orsay</h1>
                </div>
                <div class="botoes">
                    <div class="btn">
                    <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" alt="Imagem botao compartilhar"
                        aria-hidden="true" role="presentation" focusable="false"
                    ...
                    <div class="btn">
                        <svg xmlns="http://www.w3.org/2000/svg" alt="Imagem botao salvar" viewBox="0 0 32 32" aria-hidden="true"
                        role="presentation" focusable="false"
                        style="display: block; fill: none; height: 16px; width: 16px; stroke: currentcolor; stroke-width: 2; overflow: visible;">
                        <path
                ...
                <div class="image1">
                    <img
                    src="https://a0.muscache.com/im/pictures/hosting/Hosting-U3RheVN1cHBseUxpc3Rpbmc6MTE2MjI1MjI0NDQ0MzYzMjM4Mg%3D%3D/original/ae3426d1-fba4-44d4-bed2-690426f25f7a.jpeg?im_w=960&im_q=highq"
                    alt="imagem anuncio principal 1">
                </div>
                <div class="image2">
                    <img
                    src="https://a0.muscache.com/im/pictures/hosting/Hosting-U3RheVN1cHBseUxpc3Rpbmc6MTE2MjI1MjI0NDQ0MzYzMjM4Mg%3D%3D/original/bf7a757d-9352-4b37-a8c2-9656427bc7fb.jpeg?im_w=720&im_q=highq"
                    alt="imagem anuncio principal 2">
                </div>
                <div class="image4">
                    <img
                    src="https://a0.muscache.com/im/pictures/hosting/Hosting-U3RheVN1cHBseUxpc3Rpbmc6MTE2MjI1MjI0NDQ0MzYzMjM4Mg%3D%3D/original/04966b4d-fe31-4bc0-b1ca-2df033d1527a.jpeg?im_w=720&im_q=highq"
                    alt="imagem anuncio principal 3">
                </div>
                <div class="image3">
                    <img
                    src="https://a0.muscache.com/im/pictures/hosting/Hosting-U3RheVN1cHBseUxpc3Rpbmc6MTE2MjI1MjI0NDQ0MzYzMjM4Mg%3D%3D/original/ed09d57f-3074-45ae-b711-c4c1d1b7b018.jpeg?im_w=720&im_q=highq"
                    alt="imagem anuncio principal 4">
                </div>
                <div class="image5">
                    <img
                    src="https://a0.muscache.com/im/pictures/hosting/Hosting-U3RheVN1cHBseUxpc3Rpbmc6MTE2MjI1MjI0NDQ0MzYzMjM4Mg%3D%3D/original/0850c2db-06d6-4b71-bb5a-750d79fbda8a.jpeg?im_w=720&im_q=highq"
                    alt="imagem anuncio principal 5">
                </div>
                </div>
            </div>
            </div>
            ...
            <div class="container-textos">
                ...
                <div class="comodidades-produto-container">
                    ...
                    <div class="comodidade-direita">
                        ...
                        <div class="comodidade">
                            <div class="img-comodidade">
                            <svg xmlns="http://www.w3.org/2000/svg" alt="comodidade-cozinha" viewBox="0 0 32 32"
                                aria-hidden="true" role="presentation" focusable="false"
                                style="display: block; height: 24px; width: 24px; fill: currentcolor;">
                                <path
            ...
            <div class="comentario-produto-container">
                ...
                <div class="comentario-direita">
                    ...
                    <div class="conteudo-av">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" alt="Imagem rating"
                            role="presentation" focusable="false"
                            style="display: block; height: 0.5625rem; width: 0.5625rem; fill: var(--linaria-theme_palette-hof);">
                            <path fill-rule="evenodd"
                            d="m15.1 1.58-4.13 8.88-9.86 1.27a1 1 0 0 0-.54 1.74l7.3 6.57-1.97 9.85a1 1 0 0 0 1.48 1.06l8.62-5 8.63 5a1 1 0 0 0 1.48-1.06l-1.97-9.85 7.3-6.57a1 1 0 0 0-.55-1.73l-9.86-1.28-4.12-8.88a1 1 0 0 0-1.82 0z">
